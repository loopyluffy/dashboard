...
if not dbs:
    ...
    for field_name, properties in field_schema.items():
        ...
        # skip for test @luffy
        if field_name in ["id", "controller_name", "connector_name", "controller_type", 
                          "manual_kill_switch", "executor_amount_quote", "max_executors_per_side", 
                          "cooldown_time", "stop_loss", "take_profit", "time_limit", "take_profit_order_type", "trailing_stop",
