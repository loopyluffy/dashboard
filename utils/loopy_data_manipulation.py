...
# @dataclass
class LoopyBacktestingStrategyData(StrategyData):
    # orders: pd.DataFrame
    ...
    def __init__(self, trade_fill: pd.DataFrame, market_data: pd.DataFrame, position_executor: pd.DataFrame):
        ...
        # self.position_executor = position_executor
    ...
    def get_single_market_strategy_data(self, exchange: str, trading_pair: str):
        ...
        return LoopyBacktestingSingleMarketStrategyData(
            exchange=exchange,
...
# @dataclass
class LoopyBacktestingSingleMarketStrategyData(SingleMarketStrategyData):
    # exchange: str
    # trading_pair: str
    # orders: pd.DataFrame
    # order_status: pd.DataFrame
    ...
    def __init__(self, exchange: str, trading_pair: str, trade_fill: pd.DataFrame, market_data: pd.DataFrame, position_executor: pd.DataFrame):
        super().__init__(exchange, trading_pair, None, None, trade_fill, market_data, position_executor)
